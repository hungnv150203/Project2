...
function MenuBottomTabs({ active }) {
  ...
  return (
    <div className='menu-bottom-tabs'>
        <ul>
            <li className={`menu-bottom-item ${active === 'Home' && !isMenu ? 'is-active' : ''}`}>
                <Link to={'/'}>
            ...
            <li className={`menu-bottom-item ${active === '2' && !isMenu ? 'is-active' : ''}`}>
                <Link to={'/'}>
                    <FontAwesomeIcon icon={faPhone} className='icon' />
                    <span>Gọi mua hàng</span>
                </Link>
            </li>
            <li className={`menu-bottom-item ${active === '3' && !isMenu ? 'is-active' : ''}`}>
                <Link to={'/'}>
            ...
            {localStorage.getItem('auth-token')
                ...
                :<li className={`menu-bottom-item ${active === 'Login' && !isMenu ? 'is-active' : ''}`}>
                    <Link to={'/login'}>
                        <FontAwesomeIcon icon={faCircleUser} className='icon' />
                        <span>Đăng nhập</span>
                    </Link>
