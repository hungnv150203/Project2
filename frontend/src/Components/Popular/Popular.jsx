...
function Popular({ category }) {
  ...
  useEffect(() => {
    if (index < -maxIndex) {
      if (window.innerWidth > 1200) {
        setIndex((popularProducts.length > 5) ? (-(popularProducts.length - 5)) : 0);
      } 
      else if (window.innerWidth > 990) {
        setIndex((popularProducts.length > 4) ? (-(popularProducts.length - 4)) : 0);
      }
      else if (window.innerWidth > 717) {
        setIndex((popularProducts.length > 3) ? (-(popularProducts.length - 3)) : 0);
      }
      else {
        setIndex((popularProducts.length > 2) ? (-(popularProducts.length - 2)) : 0);
      }
    }
  }, [maxIndex, index])
